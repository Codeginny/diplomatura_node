  ...
  return (
    <div className="bg-blue-50 min-h-screen flex items-center justify-center">
      <div className="text-center p-10 bg-white rounded-lg shadow-xl w-full sm:w-1/2 lg:w-1/3">
        <h1 className="text-4xl font-bold text-blue-600 mb-4">Bienvenido a la App de Superhéroes</h1>
        <p className="text-lg text-gray-700 mb-6">
          Explora información sobre superhéroes, agrega nuevos, edita o elimina los existentes.
        </p>
        <Link
          to="/heroes"
